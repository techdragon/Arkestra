...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Studentship.folder'
        db.add_column('vacancies_and_studentships_studentship', 'folder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Folder'], null=True, blank=True), keep_default=False)

        # Adding field 'Vacancy.folder'
        db.add_column('vacancies_and_studentships_vacancy', 'folder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Folder'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Studentship.folder'
        db.delete_column('vacancies_and_studentships_studentship', 'folder_id')

        # Deleting field 'Vacancy.folder'
        db.delete_column('vacancies_and_studentships_vacancy', 'folder_id')
