...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name('vacancies_and_studentships_lesson_teachers')
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name('vacancies_and_studentships_lesson_teachers'))
    ...
    models = {
        ...
        'vacancies_and_studentships.lesson': {
            ...
            'teachers': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'lesson_people'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['contacts_and_people.Person']"}),
