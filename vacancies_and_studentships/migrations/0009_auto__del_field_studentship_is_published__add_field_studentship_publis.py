...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Studentship.is_published'
        db.delete_column('vacancies_and_studentships_studentship', 'is_published')

        # Adding field 'Studentship.published'
        db.add_column('vacancies_and_studentships_studentship', 'published', self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True), keep_default=False)
        ...
        # Adding field 'Studentship.creation_date'
        db.add_column('vacancies_and_studentships_studentship', 'creation_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True), keep_default=False)

        # Adding field 'Studentship.changed_date'
        db.add_column('vacancies_and_studentships_studentship', 'changed_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True), keep_default=False)

        # Deleting field 'Vacancy.is_published'
        db.delete_column('vacancies_and_studentships_vacancy', 'is_published')

        # Adding field 'Vacancy.published'
        db.add_column('vacancies_and_studentships_vacancy', 'published', self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True), keep_default=False)
        ...
        # Adding field 'Vacancy.creation_date'
        db.add_column('vacancies_and_studentships_vacancy', 'creation_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True), keep_default=False)

        # Adding field 'Vacancy.changed_date'
        db.add_column('vacancies_and_studentships_vacancy', 'changed_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Studentship.is_published'
        db.add_column('vacancies_and_studentships_studentship', 'is_published', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
        ...
        # Deleting field 'Studentship.creation_date'
        db.delete_column('vacancies_and_studentships_studentship', 'creation_date')

        # Deleting field 'Studentship.changed_date'
        db.delete_column('vacancies_and_studentships_studentship', 'changed_date')

        # Adding field 'Vacancy.is_published'
        db.add_column('vacancies_and_studentships_vacancy', 'is_published', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
        ...
        # Deleting field 'Vacancy.creation_date'
        db.delete_column('vacancies_and_studentships_vacancy', 'creation_date')

        # Deleting field 'Vacancy.changed_date'
        db.delete_column('vacancies_and_studentships_vacancy', 'changed_date')
    ...
    models = {
        ...
        'vacancies_and_studentships.studentship': {
            ...
            'changed_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
