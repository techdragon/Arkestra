...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Lesson'
        db.create_table('vacancies_and_studentships_lesson', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('external_url', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='lesson_item', null=True, on_delete=models.PROTECT, to=orm['links.ExternalLink'])),
            ...
            ('hosted_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='lesson_hosted_events', on_delete=models.SET_DEFAULT, default=None, to=orm['contacts_and_people.Entity'], blank=True, null=True)),
            ...
            ('current_students', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('vacancies_and_studentships', ['Lesson'])

        # Adding M2M table for field publish_to on 'Lesson'
        m2m_table_name = db.shorten_name('vacancies_and_studentships_lesson_publish_to')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('lesson', models.ForeignKey(orm['vacancies_and_studentships.lesson'], null=False)),
            ('entity', models.ForeignKey(orm['contacts_and_people.entity'], null=False))
        ))
        db.create_unique(m2m_table_name, ['lesson_id', 'entity_id'])

        # Adding M2M table for field please_contact on 'Lesson'
        m2m_table_name = db.shorten_name('vacancies_and_studentships_lesson_please_contact')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('lesson', models.ForeignKey(orm['vacancies_and_studentships.lesson'], null=False)),
        ...
        # Adding M2M table for field teacher on 'Lesson'
        m2m_table_name = db.shorten_name('vacancies_and_studentships_lesson_teacher')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('lesson', models.ForeignKey(orm['vacancies_and_studentships.lesson'], null=False)),
            ('person', models.ForeignKey(orm['contacts_and_people.person'], null=False))
        ...
        # Adding field 'VacanciesPlugin.lessons_heading_text'
        db.add_column('cmsplugin_vacanciesplugin', 'lessons_heading_text',
                      self.gf('django.db.models.fields.CharField')(default='Lessons', max_length=25),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Lesson'
        db.delete_table('vacancies_and_studentships_lesson')

        # Removing M2M table for field publish_to on 'Lesson'
        db.delete_table(db.shorten_name('vacancies_and_studentships_lesson_publish_to'))

        # Removing M2M table for field please_contact on 'Lesson'
        db.delete_table(db.shorten_name('vacancies_and_studentships_lesson_please_contact'))

        # Removing M2M table for field teacher on 'Lesson'
        db.delete_table(db.shorten_name('vacancies_and_studentships_lesson_teacher'))

        # Deleting field 'VacanciesPlugin.lessons_heading_text'
        db.delete_column('cmsplugin_vacanciesplugin', 'lessons_heading_text')
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 7, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'contacts_and_people.entity': {
            ...
            'vacancies_page_menu_title': ('django.db.models.fields.CharField', [], {'default': "'Classes'", 'max_length': '50'}),
        ...
        'vacancies_and_studentships.lesson': {
            'Meta': {'ordering': "['-closing_date']", 'object_name': 'Lesson'},
            ...
            'current_students': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'external_url': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'lesson_item'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': "orm['links.ExternalLink']"}),
            'hosted_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'lesson_hosted_events'", 'on_delete': 'models.SET_DEFAULT', 'default': 'None', 'to': "orm['contacts_and_people.Entity']", 'blank': 'True', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['filer.Image']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            ...
            'please_contact': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'lesson_person'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['contacts_and_people.Person']"}),
            'publish_to': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'lesson_publish_to'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['contacts_and_people.Entity']"}),
            'published': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'short_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '60', 'blank': 'True'}),
            'summary': ('django.db.models.fields.TextField', [], {}),
            'teacher': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'lesson_people'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['contacts_and_people.Person']"}),
        ...
        'vacancies_and_studentships.vacanciesplugin': {
            ...
            'lessons_heading_text': ('django.db.models.fields.CharField', [], {'default': "'Lessons'", 'max_length': '25'}),
