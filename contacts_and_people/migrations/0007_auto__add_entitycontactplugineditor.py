...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EntityContactPluginEditor'
        db.create_table('cmsplugin_entitycontactplugineditor', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('entity', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='entity_contact_plugin', null=True, on_delete=models.SET_NULL, to=orm['contacts_and_people.Entity'])),
        ))
        db.send_create_signal('contacts_and_people', ['EntityContactPluginEditor'])


    def backwards(self, orm):
        # Deleting model 'EntityContactPluginEditor'
        db.delete_table('cmsplugin_entitycontactplugineditor')
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 9, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'contacts_and_people.entitycontactplugineditor': {
            'Meta': {'object_name': 'EntityContactPluginEditor', 'db_table': "'cmsplugin_entitycontactplugineditor'", '_ormbases': ['cms.CMSPlugin']},
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'entity_contact_plugin'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['contacts_and_people.Entity']"})
        },
