...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('news_and_events_event', 'is_published')

        # Adding field 'Event.published'
        db.add_column('news_and_events_event', 'published', self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True), keep_default=False)
        ...
        db.add_column('news_and_events_event', 'creation_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True), keep_default=False)

        # Adding field 'Event.changed_date'
        db.add_column('news_and_events_event', 'changed_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True), keep_default=False)

        # Deleting field 'NewsArticle.is_published'
        db.delete_column('news_and_events_newsarticle', 'is_published')

        # Adding field 'NewsArticle.published'
        db.add_column('news_and_events_newsarticle', 'published', self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True), keep_default=False)
        ...
        # Adding field 'NewsArticle.creation_date'
        db.add_column('news_and_events_newsarticle', 'creation_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True), keep_default=False)

        # Adding field 'NewsArticle.changed_date'
        db.add_column('news_and_events_newsarticle', 'changed_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Event.is_published'
        db.add_column('news_and_events_event', 'is_published', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
        ...
        db.delete_column('news_and_events_event', 'creation_date')

        # Deleting field 'Event.changed_date'
        db.delete_column('news_and_events_event', 'changed_date')

        # Adding field 'NewsArticle.is_published'
        db.add_column('news_and_events_newsarticle', 'is_published', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
        ...
        # Deleting field 'NewsArticle.creation_date'
        db.delete_column('news_and_events_newsarticle', 'creation_date')

        # Deleting field 'NewsArticle.changed_date'
        db.delete_column('news_and_events_newsarticle', 'changed_date')
