...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('news_and_events_event', 'folder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Folder'], null=True, blank=True), keep_default=False)

        # Adding field 'NewsArticle.folder'
        db.add_column('news_and_events_newsarticle', 'folder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Folder'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.folder'
        db.delete_column('news_and_events_event', 'folder_id')

        # Deleting field 'NewsArticle.folder'
        db.delete_column('news_and_events_newsarticle', 'folder_id')
