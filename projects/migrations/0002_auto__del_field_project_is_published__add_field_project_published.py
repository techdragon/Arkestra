...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('projects_project', 'is_published')

        # Adding field 'Project.published'
        db.add_column('projects_project', 'published', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Project.is_published'
        db.add_column('projects_project', 'is_published', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
