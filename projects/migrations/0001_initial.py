...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('projects_project', (
            ...
            ('external_url', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='project_item', null=True, to=orm['links.ExternalLink'])),
            ...
            ('hosted_by', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='project_hosted_events', null=True, blank=True, to=orm['contacts_and_people.Entity'])),
        ...
        # Adding M2M table for field publish_to on 'Project'
        db.create_table('projects_project_publish_to', (
        ...
        db.create_unique('projects_project_publish_to', ['project_id', 'entity_id'])

        # Adding M2M table for field please_contact on 'Project'
        db.create_table('projects_project_please_contact', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm['projects.project'], null=False)),
            ('person', models.ForeignKey(orm['contacts_and_people.person'], null=False))
        ))
        db.create_unique('projects_project_please_contact', ['project_id', 'person_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field publish_to on 'Project'
        db.delete_table('projects_project_publish_to')

        # Removing M2M table for field please_contact on 'Project'
        db.delete_table('projects_project_please_contact')
