...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsplugin_projectplugin', (
            ...
            ('heading_text', self.gf('django.db.models.fields.CharField')(default=u'Projects', max_length=25)),
            ('entity', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='projectplugin_plugin', null=True, to=orm['contacts_and_people.Entity'])),
        ...
        db.send_create_signal('projects', ['ProjectPlugin'])
