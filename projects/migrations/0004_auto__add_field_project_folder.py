...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.folder'
        db.add_column('projects_project', 'folder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Folder'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.folder'
        db.delete_column('projects_project', 'folder_id')
