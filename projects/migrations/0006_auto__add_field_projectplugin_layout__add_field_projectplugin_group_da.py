...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProjectPlugin.layout'
        db.add_column('cmsplugin_projectplugin', 'layout', self.gf('django.db.models.fields.CharField')(default='sidebyside', max_length=25), keep_default=False)

        # Adding field 'ProjectPlugin.group_dates'
        db.add_column('cmsplugin_projectplugin', 'group_dates', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProjectPlugin.layout'
        db.delete_column('cmsplugin_projectplugin', 'layout')

        # Deleting field 'ProjectPlugin.group_dates'
        db.delete_column('cmsplugin_projectplugin', 'group_dates')
    ...
    models = {
        ...
        'projects.projectplugin': {
            ...
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'projectplugin_plugin'", 'null': 'True', 'to': "orm['contacts_and_people.Entity']"}),
            ...
            'heading_text': ('django.db.models.fields.CharField', [], {'default': "u'Projects'", 'max_length': '25'}),
