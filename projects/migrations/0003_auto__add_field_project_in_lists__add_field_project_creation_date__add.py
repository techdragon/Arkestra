...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.in_lists'
        db.add_column('projects_project', 'in_lists', self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True), keep_default=False)

        # Adding field 'Project.creation_date'
        db.add_column('projects_project', 'creation_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True), keep_default=False)

        # Adding field 'Project.changed_date'
        db.add_column('projects_project', 'changed_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True), keep_default=False)

        # Adding index on 'Project', fields ['published']
        db.create_index('projects_project', ['published'])


    def backwards(self, orm):
        
        # Removing index on 'Project', fields ['published']
        db.delete_index('projects_project', ['published'])

        # Deleting field 'Project.in_lists'
        db.delete_column('projects_project', 'in_lists')

        # Deleting field 'Project.creation_date'
        db.delete_column('projects_project', 'creation_date')

        # Deleting field 'Project.changed_date'
        db.delete_column('projects_project', 'changed_date')
    ...
    models = {
        ...
        'projects.project': {
            ...
            'external_url': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'project_item'", 'null': 'True', 'to': "orm['links.ExternalLink']"}),
            'hosted_by': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'project_hosted_events'", 'null': 'True', 'blank': 'True', 'to': "orm['contacts_and_people.Entity']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['filer.Image']", 'null': 'True', 'blank': 'True'}),
            ...
            'please_contact': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'project_person'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['contacts_and_people.Person']"}),
            'publish_to': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'project_publish_to'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['contacts_and_people.Entity']"}),
