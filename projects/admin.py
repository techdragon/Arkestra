...
from arkestra_utilities.mixins import SupplyRequestMixin, AutocompleteMixin, fieldsets, InputURLMixin
...
class ProjectForm(InputURLMixin):
    # a form for projects
    class Meta:
        model = Project
...
class ProjectAdmin(SupplyRequestMixin, AutocompleteMixin, ModelAdminWithTabsAndCMSPlaceholder):
    # exclude = ('content', 'url')
    search_fields = ['title',]
